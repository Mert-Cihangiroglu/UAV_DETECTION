...
ap.add_argument('-c', '--config', help = 'yolo config path', default = 'C:/Users/MustafaGultekin/Desktop/CS443presentation/uavTest.cfg')
ap.add_argument('-w', '--weights', help = 'yolo weigths path', default = 'C:/Users/MustafaGultekin/Desktop/CS443presentation/planeTrain_4000.weights')
ap.add_argument('-cl', '--classes', 
                help = 'path to objects.names',default='C:/Users/MustafaGultekin/Desktop/CS443presentation/uav.names')
...
cap = cv2.imread("C:/Users/MustafaGultekin/Desktop/CS443presentation/z1.png")
image= cv2.resize(cap, (416, 416)) 
